    ...
    <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between text-white">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative group">
          ...
          {/* DROPDOWN */}
          <div className="absolute right-0 mt-4 w-52 bg-white/10 backdrop-blur-xl border border-white/10 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-all duration-100 invisible group-hover:visible scale-95 group-hover:scale-100">
